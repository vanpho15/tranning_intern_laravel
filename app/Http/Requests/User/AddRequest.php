...
class AddRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'password' => ['required',new CheckMax('Password', 100), new CheckAlphaNum('Password') ],
            're-password'=> ['required','same:password',new CheckAlphaNum('Re-Password')],
    ...
    public function messages()
    {
        return [
            ...
            're-password.required' => Messages::getMessage('E001', ['Re-Password']),
